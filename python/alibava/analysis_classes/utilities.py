...
def load_plugins(valid_plugins):# used
...
def create_dictionary(abs_filepath):# used
...
def save_all_plots(name, folder, figs=None, dpi=200):# used
    """
