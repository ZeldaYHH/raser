...
gmsh.model.addPhysicalGroup(2, [surf1, surf2, surf3, surf4, surf5, surf6, surf7, surf8, surf9, surf10, surf11], name="CMOS_strip_A")

gmsh.option.setNumber("Geometry.MatchMeshTolerance", 1e-12)
gmsh.model.mesh.generate(2)

gmsh.option.setNumber("Mesh.MshFileVersion", 2.2)
gmsh.write("./setting/detector/CMOS_strip_A.msh")
gmsh.finalize()
# gmsh.fltk.run()
