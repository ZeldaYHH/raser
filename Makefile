...
test-raser-sandbox:
	apptainer shell --env-file cfg/env -B /afs,/besfs5,/cefs,/cvmfs,/etc/redhat-release,/publicfs,/scratchfs,/workfs2 /tmp/raser-sandbox 

build-raser-sif:
	apptainer build --force --fakeroot raser.sif /tmp/raser-sandbox  

shell-raser-sif:
	apptainer shell --env-file cfg/env -B /afs,/besfs5,/cefs,/cvmfs,/etc/redhat-release,/publicfs,/scratchfs,/workfs2 raser.sif 
