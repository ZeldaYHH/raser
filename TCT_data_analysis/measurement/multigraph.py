...
n1 = myt.Draw("-volt:time","Vbias==-200&&z==11.954","goff")
...
n2 = myt.Draw("-volt:time","Vbias==-200&&z==11.964","goff")
...
n3 = myt.Draw("-volt:time","Vbias==-200&&z==11.984","goff")
...
n4 = myt.Draw("-volt:time","Vbias==-200&&z==11.994","goff")
graph4 = ROOT.TGraph(n4,myt4.GetV2(),myt4.GetV1())

myFile5=ROOT.TFile("edge_voltage_2019_10_09_12_26_57_HPK-EPI-W2-200-DS-SE5-04.txt.root")
myt5 = myFile.Get("edge")
n5 = myt.Draw("-volt:time","Vbias==-200&&z==12.004","goff")
graph5 = ROOT.TGraph(n5,myt5.GetV2(),myt5.GetV1())
...
legend.AddEntry(graph, "z=11.974", "lp")
legend.AddEntry(graph1, "z=11.954", "lp")
legend.AddEntry(graph2, "z=11.964", "lp")
legend.AddEntry(graph3, "z=11.984", "lp")
legend.AddEntry(graph4, "z=11.994", "lp")
legend.AddEntry(graph5, "z=12.004", "lp")
